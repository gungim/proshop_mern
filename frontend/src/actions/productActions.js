...
export const deleteProduct = (id) => async (dispatch, getState) => {
  try {
    ...
    await axios.delete(`${host}/api/products/${id}`, config)
...
export const createProduct = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(`${host}/api/products`, {}, config)
...
export const createProductReview = (productId, review) => async (
  ...
  try {
    ...
    await axios.post(`${host}/api/products/${productId}/reviews`, review, config)
...
export const listTopProducts = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${host}/api/products/top`)
